    ...
    public function _form() {
      ...
      <div class="form-container">
        <div class="group">
          ...
          <input type="text" class="input-text" name="username" value="<?= $this->vars['username'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
        </div>

        <div class="group">
          <label><?php tr("Name");?></label>
          <span class="highlight"></span>
          <span class="bar"></span>
          <span class="error">* <?= $this->vars['nameErr'] ?></span>
          <input type="text" class="input-text" name="name" value="<?= $this->vars['name'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
        </div>

        <div class="group">
          <label><?php tr("Lastname");?></label>
          <span class="highlight"></span>
          <span class="bar"></span>
          <span class="error">* <?= $this->vars['lastnameErr'] ?></span>
          <input type="text" class="input-text" name="lastname" value="<?= $this->vars['lastname'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
        </div>
        ...
        <div class="group">
          ...
          <input type="text" class="input-text" name="email" value="<?= $this->vars['email'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
        </div>

        <?php if($this->action == 'edit') { $edit = 1; ?>
          <label> <?php tr("Lascia il campo password vuoto se non vuoi modificarlo");?> </label>
        <?php } ?>
        ...
        <div class="group">
          ...
          <input type="password" class="input-text" name="password" value="<?= $this->vars['password'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
        </div>

        <div class="group">
          <label><?php tr("Ripeti");?> Password</label>
          <span class="highlight"></span>
          <span class="bar"></span>
          <input type="password" class="input-text" name="repeat_password" value="" <?= (isset($edit)) ? "" : 'required'?>>
        </div>
        ...
        <div class="group">
          ...
          <label><?php tr("Gender");?></label>
          :
          <input type="radio" name="gender" <?= ($this->vars['gender']=="F") ? "checked" : "" ?> value="F"><?php tr("Female");?>
          <input type="radio" name="gender" <?= ($this->vars['gender']=="M") ? "checked" : "" ?> value="M"><?php tr("Male");?>
          <input type="radio" name="gender" <?= ($this->vars['gender']=="N.D.") ? "checked" : "" ?> value="N.D."><?php tr("Other");?>
