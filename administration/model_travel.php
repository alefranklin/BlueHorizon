      ...
      global $db;
            ...
            <div class="form-container">
              <div class="group">
                ...
                <h3> <?php tr("ID Viaggio:");?> <?php echo $this->id; ?> </h3>

                <label><?php tr("Destination");?></label>
                <span class="error">* <?= $this->vars['arrivalErr'] ?></span>
                  <select name="arrival" class="input-text" <?= (isset($edit)) ? "" : 'required'?>>
                    <?php

                      $getArrival="SELECT name, id from  planets";
                      $arrival_result=mysqli_query($db, $getArrival);
                      echo "<option value=\"\" disabled>Placeholder</option>";
              ...
              <div class="group">
                <label><?php tr("Rocket");?></label>
                <span class="error">* <?= $this->vars['arrivalErr'] ?></span>
                  <select class="input-text" name="rocket" <?= (isset($edit)) ? "" : 'required'?>>
              ...
              <div class="group">
                <label><?php tr("Date");?></label>
                <span class="error">* <?= $this->vars['departure_dateErr'] ?></span>
                  <input type="date" class="input-text" name="departure_date" value="<?= $this->vars['departure_date'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
                  <span class="highlight"></span>
                  <span class="bar"></span>
              </div>

              <div class="group">
                <label><?php tr("Duration");?></label>
                <span class="error">* <?= $this->vars['departure_dateErr'] ?></span>
                <input type="number" class="input-text" min="1" name="duration" value="<?= $this->vars['duration'] ?>" <?= (isset($edit)) ? "" : 'required'?>>
                <span class="highlight"></span>
                <span class="bar"></span>
              </div>
