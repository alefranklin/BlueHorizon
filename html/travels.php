  ...
  <div id="travel-content">
    ...
    <div id="travel-list">
        ...
        <div class="travel-panel" id="mercury-banner">
            ...
            <a href="planets.php?planet=Mercurio" title="<?php tr("See more infos about our Mercury trip") ?>" aria-describedby="mercury"> </a>
        </div>

      <br>

        <div class="travel-panel" id="venus-banner">
            <h1 class="space-font" id="venus"> <?php tr("VENUS") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Venere" title="<?php tr("See more infos about our Venus trip") ?>" aria-describedby="venus"></a>
            </div>

      <br>

        <div class="travel-panel" id="earth-banner">
            <h1 class="space-font" id="earth"> <?php tr("EARTH") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Terra" title="<?php tr("See more infos about our Earth trip") ?>" aria-describedby="earth"></a>
            </div>

      <br>

        <div class="travel-panel" id="moon-banner">
            <h1 class="space-font" id="moon"> <?php tr("MOON") ?></h1>
            <p>
            ...
            <a href="planets.php?planet=Luna" title="<?php tr("See more infos about our Moon trip") ?>" aria-describedby="moon"></a>
        </div>

      <br>

        <div class="travel-panel" id="mars-banner">
            <h1 class="space-font" id ="mars"> <?php tr("MARS") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Marte" title="<?php tr("See more infos about our Mars trip") ?>" aria-describedby="mars"></a>
        </div>

      <br>

        <div class="travel-panel" id="jupiter-banner">
            <h1 class="space-font" id="jupiter"> <?php tr("JUPITER") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Giove" title="<?php tr("See more infos about our Jupiter trip") ?>" aria-describedby="jupiter"></a>
        </div>

      <br>

        <div class="travel-panel" id="io-banner">
            <h1 class="space-font" id="io"> <?php tr("IO") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Io" title="<?php tr("See more infos about our Io trip") ?>" aria-describedby="io"></a>
        </div>

      <br>

        <div class="travel-panel" id="europa-banner">
            <h1 class="space-font" id="europa"> <?php tr("EUROPA") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Europa" title="<?php tr("See more infos about our Europa trip") ?>" aria-describedby="europa"></a>
        </div>

      <br>

        <div class="travel-panel" id="saturn-banner">
            <h1 class="space-font" id="saturn"> <?php tr("SATURN") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Saturno" title="<?php tr("See more infos about our Saturn trip") ?>" aria-describedby="saturn"></a>
        </div>

      <br>

        <div class="travel-panel" id="uranus-banner">
            <h1 class="space-font" id="uranus"> <?php tr("URANUS") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Urano" title="<?php tr("See more infos about our Uranus trip") ?>" aria-describedby="uranus"> </a>
        </div>

      <br>

        <div class="travel-panel" id="neptune-banner">
            <h1 class="space-font" id="neptune"> <?php tr("NEPTUNE") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Nettuno" title="<?php tr("See more infos about our Neptune trip") ?>" aria-describedby="neptune"></a>
        </div>

      <br>

        <div class="travel-panel" id="pluto-banner">
            <h1 class="space-font" id="pluto"> <?php tr("PLUTO") ?> </h1>
            <p>
            ...
            <a href="planets.php?planet=Plutone" title="<?php tr("See more infos about our Pluto trip") ?>" aria-describedby="pluto"></a>
        </div>
