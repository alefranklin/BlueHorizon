    ...
    <div id="travel-list">
      ...
      <br>
        ...
        <div class="travel-panel" id="venus-banner">
            ...
            <a href="planets.php?planet=Venere" title="See more infos about our Venus trip"></a>
            </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="earth-banner">
            ...
            <a href="planets.php?planet=Terra" title="See more infos about our Earth trip"></a>
            </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="moon-banner">
            ...
            <a href="planets.php?planet=Luna" title="See more infos about our Moon trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="mars-banner">
            ...
            <a href="planets.php?planet=Marte" title="See more infos about our Mars trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="jupiter-banner">
            ...
            <a href="planets.php?planet=Giove" title="See more infos about our Jupiter trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="io-banner">
            ...
            <a href="planets.php?planet=Io" title="See more infos about our Io trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="europa-banner">
            ...
            <a href="planets.php?planet=Europa" title="See more infos about our Europa trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="saturn-banner">
            ...
            <a href="planets.php?planet=Saturno" title="See more infos about our Saturn trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="uranus-banner">
            ...
            <a href="planets.php?planet=Urano" title="See more infos about our Uranus trip"> </a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="neptune-banner">
            ...
            <a href="planets.php?planet=Nettuno" title="See more infos about our Neptune trip"></a>
        </div>
      ...
      <br>
        ...
        <div class="travel-panel" id="pluto-banner">
            ...
            <a href="planets.php?planet=Plutone" title="See more infos about our Pluton trip"></a>
        </div>
